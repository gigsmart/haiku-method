...
status: pending
quality_gates:
  - Happy path flow specified for all 3 session types (review, question, direction)
  ...
  - Stepped review UX specified (section navigation, comment state, decision inference)
---
