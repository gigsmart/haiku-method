...
- HTTP feedback-create endpoint (`handleFeedbackPost`, http.ts:1526) hardcodes `author: "user"` and uses a human origin (`user-visual`, `user-chat`, or `user-question` depending on the composer mode) — **correct pattern**.
