...
outputs:
  - packages/haiku/src/server.ts (resources capability + handlers)
  - packages/haiku/src/review-app-html.ts (adds REVIEW_APP_VERSION)
  - packages/haiku/scripts/build-review-app.mjs (emit version hash)
  - packages/haiku/src/ui-resource.ts (new buildUiResourceMeta helper)
---
