...
**Produces:** Gherkin feature files with scenarios covering happy paths, error paths, and edge cases. Data contracts as schemas. Record produced spec documents in the unit's `outputs:` frontmatter field as paths relative to the intent directory.

**Reads:** Product hat's user stories and acceptance criteria, discovery via the unit's `## References` section.

**Anti-patterns (RFC 2119):**
- The agent **MUST** write behavioral specs as Gherkin scenarios — not prose, not pseudocode, not bullet lists
