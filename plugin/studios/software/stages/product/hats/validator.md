...
**Produces:** Coverage mapping (success criterion → AC/spec items) and a validation decision — APPROVED or GAPS FOUND. When gaps are found, flag the specific missing criterion and recommend which hat (product or specification) should address it.
