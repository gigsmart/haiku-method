...
All commands are MCP prompts on the `haiku` server. Invoke them as `/haiku:start`, `/haiku:resume`, etc. Do NOT use the Skill tool for haiku commands — they are MCP prompts, not skills.
