...
- [ ] `/haiku:start` skill exists and creates intents with studio, stages, active_stage, and mode
- [ ] `/haiku:start` correctly detects studio from settings and resolves stage list
- [ ] `/haiku:resume` skill exists and advances through stages
- [ ] `/haiku:resume` with explicit stage argument runs that specific stage
- [ ] `/haiku:resume` without stage argument auto-advances to next incomplete stage
