...
<Grid>
  <Card eyebrow="Interactive" title="Runtime architecture map" accent="info">
    The full map — actors, hooks, FSM phases, MCP tools, knowledge pool, pre- and post-intent flows. Every chip clicks through to real source. [Open the map →](/prototype-stage-flow.html)
  </Card>
