...
Going back never destroys later work. It switches branches, lets you fix the issue upstream, and merges the fix forward when you return. Your downstream branches keep everything they had, plus the fix.
</Callout>
