	...
	steps: [
			...
			actions: [
				{
					...
					role: "agent",
					label: "agent",
					text: "Hat: architect. Starting OAuth provider setup \u2014 mapping provider abstraction layer...",
				},
			],
		},
		...
		{ delay: 500, actions: [{ type: "fastForward", seconds: "30" }] },
		{
			...
			actions: [
				...
				{ type: "file", path: `${P}/knowledge/DESIGN-TOKENS.md` },
				{
					type: "file",
					path: `${P}/stages/design/artifacts/login-screen-desktop.png`,
				},
				{
					type: "file",
					path: `${P}/stages/design/artifacts/login-screen-mobile.png`,
				},
				{ type: "file", path: `${P}/stages/design/artifacts/oauth-flow.png` },
				{
					type: "msg",
					role: "agent",
					label: "agent",
					text: "Design brief and hi-fi mockups written to intent spec. Tokens extracted to knowledge. Desktop and mobile login screens plus OAuth flow diagram committed as design artifacts. All breakpoints, interactive states, accessible color contrast verified.",
				},
			],
		},
			...
			actions: [
				{
					...
					role: "system",
					label: "system",
					text: "Resolved inputs \u2192 inception/discovery (knowledge/DISCOVERY.md), design/design-brief (stages/design/DESIGN-BRIEF.md), design/design-tokens (knowledge/DESIGN-TOKENS.md)",
				},
				{
					type: "msg",
					role: "agent",
					label: "agent",
					text: "Design brief specifies full-page login with social buttons and forgot-password link. Tokens define spacing, colors, breakpoints.\nElaborating product work from design artifacts...",
				},
				{
					type: "file",
		...
		{ delay: 800, actions: [{ type: "typing" }] },
		{
			...
			actions: [
				...
				{ type: "file", path: `${P}/knowledge/BEHAVIORAL-SPEC.md` },
				{ type: "file", path: `${P}/knowledge/DATA-CONTRACTS.md` },
				{
					type: "updateCard",
					stage: "product",
					name: "auth-spec",
		...
		},
		{
			...
			actions: [
				...
				},
				{
					...
					role: "agent",
					label: "agent",
					text: "Design brief: full-page login with social buttons + forgot-password link. Tokens: spacing and color system. Product spec: OAuth callback flow with 429 rate limiting.\nElaborating into implementation units...",
				},
				{
					type: "file",
		...
		},
		{
			...
			actions: [
				...
				{ type: "file", path: "src/lib/oauth/provider.ts" },
				{ type: "file", path: "src/lib/oauth/callback.ts" },
				{ type: "file", path: "src/components/LoginPage.tsx" },
				{ type: "file", path: ".haiku/knowledge/ARCHITECTURE.md" },
			],
		},
		{
			delay: 800,
		...
		{ delay: 500, actions: [{ type: "fastForward", seconds: "35" }] },
		{
			...
			actions: [
				...
				{ type: "file", path: "deploy/terraform/oauth.tf" },
				{ type: "file", path: ".haiku/knowledge/RUNBOOK.md" },
			],
		},
		{
			delay: 800,
		...
		{ delay: 500, actions: [{ type: "fastForward", seconds: "15" }] },
		{
			...
			actions: [
				...
				{ type: "file", path: ".haiku/knowledge/THREAT-MODEL.md" },
				{ type: "file", path: `${P}/knowledge/VULN-REPORT.md` },
			],
		},
		{
			delay: 1000,
