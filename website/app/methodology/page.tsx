...
const phases = [
	{
		...
		detail:
			"Collaborative planning that produces clear intent, elaborated work, and verifiable completion criteria.",
	...
	},
	{
		...
		detail:
			"Elaborate, execute, adversarial review, and gate. Artifacts persist automatically. Work that fails review does not advance.",
			...
			<section className="px-4 py-16 sm:py-24">
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="text-lg text-stone-600 dark:text-stone-400">
						A universal framework for structured human-AI collaboration. Four
						phases that turn unstructured AI interactions into disciplined,
				...
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							Without structure, AI-assisted work suffers from predictable
							failure modes. H·AI·K·U addresses each one.
						</p>
					</div>
				...
				<div className="mx-auto max-w-5xl">
					<div className="mb-12 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							...
							and reflection. The output of each phase feeds the next, creating
					...
					<div className="grid gap-6 md:grid-cols-2">
						{phases.map((phase) => (
							...
							>
								...
								<span
									className={`mt-3 inline-block text-sm font-medium ${phase.textColor}`}
								>
									Learn more &rarr;
								</span>
							</Link>
							...
							<div className="space-y-3">
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-stone-600 dark:text-stone-400">
											Agent breaks work into units with verifiable completion
											criteria.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-stone-600 dark:text-stone-400">
											Agent runs the hat sequence, producing stage-specific
											deliverables.
										</p>
									</div>
								</div>
								<div className="flex items-start gap-3">
									...
									<div>
										...
										<p className="text-sm text-stone-600 dark:text-stone-400">
											Adversarial review evaluates work against completion
											criteria.
										</p>
									</div>
								</div>
						...
						<div className="rounded-xl border border-stone-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-950">
							...
							<div className="space-y-3">
								...
								<div className="rounded-lg bg-stone-50 p-3 dark:bg-stone-900">
									...
									<p className="text-sm text-stone-600 dark:text-stone-400">
										Adversarial review against criteria. Cannot be the same
										agent that built.
									</p>
								</div>
							</div>
				...
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							...
							&ldquo;ideation&rdquo; studio works for everything. Specialized
							studios add domain-specific stages and review modes.
						</p>
					</div>
				...
				<div className="mx-auto max-w-5xl">
					<div className="mb-10 text-center">
						...
						<p className="mx-auto max-w-2xl text-stone-600 dark:text-stone-400">
							...
							defines three modes — like a GPS that can be set to guide,
							monitor, or autopilot.
						</p>
					</div>
				...
				<div className="mx-auto max-w-5xl">
					...
					<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
						{phases.map((phase) => (
							...
							>
								<div className={`mx-auto mb-2 w-8 ${phase.textColor}`}>
									{phase.icon}
								</div>
