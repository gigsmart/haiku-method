					...
					{mermaid && (
						<>
							...
							{dagMaximized && (
								...
								>
									{/* biome-ignore lint/a11y/useKeyWithClickEvents: inner panel only stops click propagation */}
									<div
		...
		<>
										...
										return (
											...
											>
												...
												<button
													type="button"
													onClick={() => {
														const next = a.relativePath ?? null
														setExpandedImage(
															expandedImage === next ? null : next,
														)
													}}
			...
			{expandedImage && (
				<div
					...
					// biome-ignore lint/a11y/useSemanticElements: native <dialog> would be a separate refactor; this ad-hoc modal already handles Escape and click-to-dismiss
					role="dialog"
					aria-label="Expanded artifact"
				>
					<img
						src={expandedImage}
