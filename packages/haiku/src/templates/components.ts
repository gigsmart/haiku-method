...
(function() {
  ...
  function updateDecisionButtons() {
    ...
    if (hasFeedback) {
      ...
      changesBtn.className = 'flex-1 px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white text-sm font-semibold rounded-lg transition-colors focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900';
    } else {
