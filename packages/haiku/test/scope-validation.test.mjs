...
test("exact file match", () => {
	assert.ok(
		matchesGlob(
			"stages/design/artifacts/foo.html",
			"stages/design/artifacts/foo.html",
		),
	)
})
...
test("exact file non-match", () => {
	assert.ok(
		!matchesGlob(
			"stages/design/artifacts/bar.html",
			"stages/design/artifacts/foo.html",
		),
	)
})
...
test("trailing / matches files under", () => {
	assert.ok(
		matchesGlob("stages/design/artifacts/foo.html", "stages/design/artifacts/"),
	)
})
...
test("dir prefix does NOT match sibling", () => {
	assert.ok(
		!matchesGlob("stages/design/units/foo.md", "stages/design/artifacts"),
	)
})
...
test("trailing /** matches nested descendants", () => {
	assert.ok(
		matchesGlob(
			"stages/design/artifacts/a/b/foo.html",
			"stages/design/artifacts/**",
		),
	)
})
...
test("trailing /** matches the bare dir too", () => {
	assert.ok(
		matchesGlob("stages/design/artifacts", "stages/design/artifacts/**"),
	)
})
...
test("/*.ext does NOT cross directories", () => {
	assert.ok(
		!matchesGlob(
			"stages/design/artifacts/sub/foo.html",
			"stages/design/artifacts/*.html",
		),
	)
})
...
test("unit-04.md whitelist does not match unit-05.md", () => {
	assert.ok(
		matchesGlob(
			"stages/design/units/unit-04.md",
			"stages/design/units/unit-04.md",
		),
	)
	assert.ok(
		!matchesGlob(
			"stages/design/units/unit-05.md",
			"stages/design/units/unit-04.md",
		),
	)
})
...
test("unit-04 whitelist does not accidentally match via prefix", () => {
	...
	assert.ok(
		!matchesGlob(
			"stages/design/units/unit-04.md.bak",
			"stages/design/units/unit-04.md",
		),
	)
	assert.ok(
		!matchesGlob(
			"stages/design/units/unit-040.md",
			"stages/design/units/unit-04.md",
		),
	)
})
