...
import {
	type BootPhase,
	IframeBootScreen,
} from "./components/iframe/IframeBootScreen"
...
function SessionLoader({
	sessionId,
	pageType,
}: { sessionId: string; pageType: string }) {
	...
	const [staleHostWarning, setStaleHostWarning] = useState<{
		host: string
		expected: string
	} | null>(null)
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: isIframe is module-level constant, not reactive
	useEffect(() => {
		if (!isIframe) return
