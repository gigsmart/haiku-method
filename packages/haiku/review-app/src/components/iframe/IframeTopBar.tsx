import { type BridgeStatus, HostBridgeStatus } from "./HostBridgeStatus"
			...
			<div className="flex items-center gap-2 min-w-0">
				{slug && (
					<span
						...
						aria-label={`Intent: ${slug}`}
					>
						{slug}
					</span>
				)}
				{slug && sessionType && (
					<span className="text-stone-700 text-xs" aria-hidden="true">
						·
					</span>
				)}
				{sessionType && (
