 ...
 */
export function BottomSheetDecisionPanelReview({ sessionId, annotations, wsRef }: Props) {
  ...
  return (
    <>
      ...
      >
        ...
        <h3 id="decision-form-heading" className="sr-only">Review Decision</h3>
        ...
        >
          ...
          {isHalfPane && (
            <div className="mb-3">
              <label htmlFor="review-feedback" className="sr-only">Feedback (optional)</label>
              <textarea
                ref={feedbackRef}
                id="review-feedback"
                rows={4}
          ...
          <p className="mt-2 text-center text-xs text-stone-500" aria-hidden="true">
