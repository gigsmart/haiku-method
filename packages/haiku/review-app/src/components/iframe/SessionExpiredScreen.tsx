    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      >
        ...
        <div className="flex justify-center">
          <div className="w-12 h-12 rounded-full bg-stone-800 flex items-center justify-center" aria-hidden="true">
        ...
        <div className="text-center">
          <h2 className="text-base font-semibold text-stone-100 mb-1">Session Expired</h2>
          <p className="text-sm text-stone-300">
            This review session has expired. Ask Claude Code to generate a new review link.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-xs text-stone-500">Copy this message to send to Claude Code:</p>
          {showTextarea ? (
            <textarea
              readOnly
              value={RECOVERY_TEXT}
            ...
            >
              {copied ? "Copied!" : "\u{1F4CB} Copy \u201CPlease generate a new review link\u201D"}
            </button>
          )}
        </div>
      </div>
