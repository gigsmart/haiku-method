 ...
 */
export function BottomSheetDecisionPanelDesign({ sessionId, selectedArchetype, paramValues, wsRef }: Props) {
  ...
  return (
    <div
      ...
      data-snap={snap}
    >
      <h3 id="design-form-heading" className="sr-only">Choose Design Direction</h3>
      ...
      <div className="px-3 pb-3" aria-labelledby="design-form-heading">
        {selectedArchetype && (
          <p className="text-xs text-stone-400 mb-2 text-center">
            Selected: <span className="text-stone-200 font-medium">{selectedArchetype}</span>
          </p>
        )}
